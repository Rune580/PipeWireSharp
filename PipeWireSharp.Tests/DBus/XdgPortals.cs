...
namespace PipeWireSharp.Tests.DBus;
...
partial class Inhibit : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchStateChangedAsync(
        ...
        => WatchSignalAsync(Service.Destination, __Interface, Path, "StateChanged",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public Task<uint> GetVersionAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "version"),
...
partial class Location : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchLocationUpdatedAsync(
        ...
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "LocationUpdated",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
...
partial class Notification : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchActionInvokedAsync(
        ...
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "ActionInvoked",
            (Message m, object? s) => ReadMessage_ssav(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public Task<Dictionary<string, VariantValue>> GetSupportedOptionsAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedOptions"),
...
partial class NetworkMonitor : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchChangedAsync(Action<Exception?> handler, bool emitOnCapturedContext = true,
        ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "changed", handler, emitOnCapturedContext, flags);
...
partial class Print : DesktopObject
{
    ...
    public Task<ObjectPath> PrintAsync(string parentWindow, string title, System.Runtime.InteropServices.SafeHandle fd,
        Dictionary<string, VariantValue> options)
    {
        return Connection.CallMethodAsync(CreateMessage(),
            (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
...
partial class Settings : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchSettingChangedAsync(
        ...
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "SettingChanged",
...
partial class GameMode : DesktopObject
{
    ...
    public Task<bool> GetActiveAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Active"),
...
partial class RemoteDesktop : DesktopObject
{
    ...
    public Task NotifyPointerMotionAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options, double dx,
        double dy)
    {
        return Connection.CallMethodAsync(CreateMessage());
    ...
    public Task NotifyPointerButtonAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options, int button,
        uint state)
    {
        return Connection.CallMethodAsync(CreateMessage());
    ...
    public Task NotifyPointerAxisAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options, double dx,
        double dy)
    {
        return Connection.CallMethodAsync(CreateMessage());
    ...
    public Task NotifyTouchDownAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options, uint stream,
    ...
    public Task NotifyTouchMotionAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options, uint stream,
        uint slot, double x, double y)
    {
        return Connection.CallMethodAsync(CreateMessage());
    ...
    public Task<uint> GetAvailableDeviceTypesAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableDeviceTypes"),
            (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
...
partial class MemoryMonitor : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchLowMemoryWarningAsync(Action<Exception?, byte> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "LowMemoryWarning",
...
partial class Realtime : DesktopObject
{
    ...
    public Task<int> GetMaxRealtimePriorityAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MaxRealtimePriority"),
            (Message m, object? s) => ReadMessage_v_i(m, (DesktopObject)s!), this);

    public Task<int> GetMinNiceLevelAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MinNiceLevel"),
            (Message m, object? s) => ReadMessage_v_i(m, (DesktopObject)s!), this);

    public Task<long> GetRTTimeUSecMaxAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "RTTimeUSecMax"),
...
partial class Camera : DesktopObject
{
    ...
    public Task<bool> GetIsCameraPresentAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "IsCameraPresent"),
            (Message m, object? s) => ReadMessage_v_b(m, (DesktopObject)s!), this);
...
partial class InputCapture : DesktopObject
{
    ...
    public Task<ObjectPath> SetPointerBarriersAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
    ...
    public ValueTask<IDisposable> WatchDisabledAsync(
        ...
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "Disabled",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public ValueTask<IDisposable> WatchActivatedAsync(
        Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Options)> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "Activated",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public ValueTask<IDisposable> WatchDeactivatedAsync(
        Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Options)> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "Deactivated",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public ValueTask<IDisposable> WatchZonesChangedAsync(
        Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Options)> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "ZonesChanged",
            (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);

    public Task<uint> GetSupportedCapabilitiesAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedCapabilities"),
            (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
...
partial class GlobalShortcuts : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchActivatedAsync(
        ...
        ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "Activated",
            (Message m, object? s) => ReadMessage_ostaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
    ...
    public ValueTask<IDisposable> WatchShortcutsChangedAsync(
        Action<Exception?, (ObjectPath SessionHandle, (string, Dictionary<string, VariantValue>)[] Shortcuts)> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "ShortcutsChanged",
...
partial class PowerProfileMonitor : DesktopObject
{
    ...
    public Task<bool> GetPowerSaverEnabledAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "power-saver-enabled"),
            (Message m, object? s) => ReadMessage_v_b(m, (DesktopObject)s!), this);
    ...
    public ValueTask<IDisposable> WatchPropertiesChangedAsync(
        Action<Exception?, PropertyChanges<PowerProfileMonitorProperties>> handler, bool emitOnCapturedContext = true,
        ObserverFlags flags = ObserverFlags.None)
    {
        return base.WatchPropertiesChangedAsync(__Interface,
            (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
...
partial class DynamicLauncher : DesktopObject
{
    ...
    public Task<uint> GetSupportedLauncherTypesAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedLauncherTypes"),
            (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
...
partial class ScreenCast : DesktopObject
{
    ...
    public Task<uint> GetAvailableSourceTypesAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableSourceTypes"),
            (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);

    public Task<uint> GetAvailableCursorModesAsync()
        => Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableCursorModes"),
            (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
...
partial class Session : DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchClosedAsync(Action<Exception?, Dictionary<string, VariantValue>> handler,
        bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        => WatchSignalAsync(Service.Destination, __Interface, Path, "Closed",
            (Message m, object? s) => ReadMessage_aesv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
    ...
    public ValueTask<IDisposable> WatchPropertiesChangedAsync(
        Action<Exception?, PropertyChanges<SessionProperties>> handler, bool emitOnCapturedContext = true,
        ObserverFlags flags = ObserverFlags.None)
    {
        return base.WatchPropertiesChangedAsync(__Interface,
            (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
        ...
        static PropertyChanges<SessionProperties> ReadMessage(Message message, DesktopObject _)
        {
            ...
            reader.ReadString(); // interface
            List<string> changed = new(), invalidated = new();
            return new PropertyChanges<SessionProperties>(ReadProperties(ref reader, changed),
                ReadInvalidated(ref reader), changed.ToArray());
        }
...
class DesktopObject
{
    ...
    public ValueTask<IDisposable> WatchSignalAsync<TArg>(string sender, string @interface, ObjectPath path,
        string signal, MessageValueReader<TArg> reader, Action<Exception?, TArg> handler, bool emitOnCapturedContext,
        ObserverFlags flags)
    {
        var rule = new MatchRule
        {
        ...
        Action<Exception?> handler, bool emitOnCapturedContext, ObserverFlags flags)
    {
        ...
        return Connection.AddMatchAsync<object>(rule, (Message message, object? state) => null!,
            (Exception? ex, object v, object? rs, object? hs) => ((Action<Exception?>)hs!).Invoke(ex), this, handler,
    ...
    protected static (ObjectPath, string, ulong, Dictionary<string, VariantValue>) ReadMessage_ostaesv(Message message,
        DesktopObject _)
    {
        var reader = message.GetBodyReader();
        var arg0 = reader.ReadObjectPath();
    ...
    protected static (ObjectPath, (string, Dictionary<string, VariantValue>)[]) ReadMessage_oarsaesvz(Message message,
        DesktopObject _)
    {
        var reader = message.GetBodyReader();
        var arg0 = reader.ReadObjectPath();
...
class PortalResponse
{
    ...
    public override string ToString()
    {
        ...
        var lastIndex = requestPath.LastIndexOf('/');
        if (lastIndex == -1 || lastIndex == requestPath.Length - 1)
            requestPath = "";

        requestPath = requestPath[(lastIndex + 1)..];
